...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(gardenId) {
    var stripe, session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51Iz4jeSJZMM3bl9Qllm7TZzswGDn3ZVgzCRxOH7FAU7wUiuM2ugDNmM4p4M0EDvLPpAbopEd0P8X0LjA1dmnI7eD00qrpw7Ytv');
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)("/api/v1/booking/checkout-session/".concat(gardenId));
  ...
  return function bookGarden(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.bookGarden = bookGarden;
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var gardenId = e.target.dataset.gardenId;
  (0, _stripe.bookGarden)(gardenId);
});
